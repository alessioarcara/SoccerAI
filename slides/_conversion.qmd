...
- **Why graphs?**
    ...
    - We model the problem as a **complete weighted bipartite graph** where each player is connected to every opponent and each edge’s weight is determined by the distance between the two players. 
...
![](resources/bipartite_graph.svg){width=80% fig-alt="Complete 11×11 bipartite graph between attackers and defenders"}
