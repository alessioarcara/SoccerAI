...
- **Why weight the edges?**
    ...
    - Thus, edge weights are computed as $\displaystyle w_{ij} = e^{-d_{ij}}$, where $\displaystyle d_{ij} = \lVert {p}_i - {p}_j\rVert_2$ and ${p}_i, {p}_j$ denote the 2D field coordinates of players $i$ and $j$.
:::
