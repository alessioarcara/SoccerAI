...
- **Dataset**: [FIFA World Cup 2022 (PFF.com)](https://www.blog.fc.pff.com/blog/pff-fc-release-2022-world-cup-data)  
  ...
  - **Additional Player Statistics**: player profiles and performance scraped from [TransferMarkt](https://www.transfermarkt.com/) & [FBRef](https://fbref.com/en/)


- **Focus: Event Data**
  - We enrich each event computing every player’s speed and direction with the **60 preceding tracking frames**.
  - In total we analyze **19 048 tracking frames**, organised into chains that capture individual football actions.
...
<div style="display: flex; align-items: center; gap: 1em; height: 75px;">

<img src="resources/dataset/pff_logo.png" alt="PFF Logo" style="height: 60px;" />

<img src="resources/dataset/tm_logo.svg" alt="TransferMarkt Logo" id="tm_logo" style="height: 60px;width: 120px" />

<img src="resources/dataset/fb_logo.svg" alt="FBRef Logo" id="fb_logo" style="height: 60px;width: 150px" />
...
- **Spatial features**
  ...
  - **ball_dist** → distance between player and ball ([0,1])
